/*
 An extra class to print a satellite that rotates over its axis as it orbits over our location.
Based on a sketch by toxi! But I forgot which one... It keeps some of his comments. 
*/
...
class SatModel {
  ...
  public void display() {
    ...
    // avoid "over-spinning"
    theta%=TWO_PI;
    // create the arc as triangle strip
    noStroke();
